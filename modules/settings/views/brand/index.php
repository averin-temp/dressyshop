...
<?php if($data->count > 0) : ?>
    ...
    <table width="100%">
        ...
        <?php foreach ($data->models as $item) : ?>
            ...
            <tr>
                ...
                <td> <a href="<?= Url::to(['/admin/' . $module . '/brand/edit', 'id' => $item->primaryKey]) ?>"><?= $item->name ?></a></td>
                <td class="lidrag_del" width="20"><a
                            href="<?= Url::to(['/admin/' . $module . '/brand/delete', 'id' => $item->primaryKey]) ?>"><span
    ...
    <script>
        function funcsortdrag() {
            ...
            $.ajax({
                type: "POST",
                url: "/admin/settings/brand/savedrag",
